...
namespace TOM.Apps.Learning
{
    ...
    public class LearningController : HomeController
    {
        ...
        public void HighlightPointSelection(int dataType, HighlightPointData highlightPointData)
        {
            ...
            Vector3 point = new Vector3((float)highlightPointData.WorldX, (float)highlightPointData.WorldY,
                (float)highlightPointData.WorldZ);
        ...
        private void handleGazeGesture(IMixedRealityEyeGazeProvider eyeGazeProvider, Camera camera)
        {
            ...
            Vector3 gazePosition = eyeGazeProvider.GazeOrigin +
                                   eyeGazeProvider.GazeDirection.normalized * DEFAULT_GAZE_CURSOR_DISTANCE;
