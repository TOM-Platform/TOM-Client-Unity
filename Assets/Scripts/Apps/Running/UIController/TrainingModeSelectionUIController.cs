...
namespace TOM.Apps.Running
{
    ...
    public class TrainingModeSelectionUIController : BaseUIController
    {
        ...
        {
            UpdateButtonTextAndIcon(getRunningTypePosition(UIDataType.SelectionDistance), "Distance", distanceSprite,
                runningController.SelectDistanceTraining);
            UpdateButtonTextAndIcon(getRunningTypePosition(UIDataType.SelectionSpeed), "Speed", speedSprite,
                runningController.SelectSpeedTraining);
        }
    }
