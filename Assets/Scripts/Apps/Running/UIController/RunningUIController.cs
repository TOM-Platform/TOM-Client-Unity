using static TOM.Common.Utils.ValidInput;
    ...
    public class RunningUIController : BaseUIController
    {
        ...
        internal void UpdateRunningUI(RunningLiveData runningLiveData, string targetContent, bool isUnit, bool isAlert)
        {
            ...
            if (isAlert)
            {
                ...
                {
                    UpdateBackgroundColor(getRunningTypePosition(UIDataType.RunningSpeed),
                        bool.Parse(runningLiveData.Speed), speedColor);
                }
