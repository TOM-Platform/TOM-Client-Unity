...
public class GoogleMap : MonoBehaviour {
    ...
    {
        Debug.Log("UpdateMarkers: " + start_location.latitude + "," + start_location.longitude + "|" + end_location.latitude + "," + end_location.longitude);
    ...
    IEnumerator _Refresh() {
        ...
        if (request.isNetworkError || request.isHttpError) {
            ...
            spriteRenderer.sprite = Sprite.Create(texture, new Rect(0, 0, texture.width, texture.width), new Vector2(0, 0), pixelsPerUnit);
